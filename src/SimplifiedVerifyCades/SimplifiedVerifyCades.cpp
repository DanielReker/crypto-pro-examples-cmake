...
/*
Пример проверки подписи CADES_X_LONG_TYPE_1 с помощью упрощённых функций КриптоПро ЭЦП SDK.
...
sign.dat должен находится в каталоге приложения. Также в хранилище сертификатов необходимо 
...
int main(void)
{
    ...
    cadesVerifyPara.dwCadesType = CADES_X_LONG_TYPE_1; // Указываем тип проверяемой подписи CADES_X_LONG_TYPE_1
